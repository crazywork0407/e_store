                        ...
                        <div class="header-left">
                            ...
                            <nav class="main-nav font2">
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="demo12-product.html">Products</a>
                                    ...
                                    <li><a href="https://1.envato.market/DdLk5" target="_blank">Buy Porto!</a><em
                                            class="tip hot position-absolute">HOT!</em></li>
                                </ul>
                            </nav>
                        </div><!-- End .header-left -->
                        ...
                        <div class="header-right">
                            ...
                            <div class="dropdown cart-dropdown">
                                <a href="#" class="dropdown-toggle dropdown-arrow cart-toggle" role="button"
                                    ...
                                    <span class="cart-count badge-circle bg-secondary">3</span>
                                </a>
                                        ...
                                        <div class="dropdown-cart-products">
                                            <div class="product">
                                                ...
                                                <figure class="product-image-container">
                                                    <a href="demo12-product.html" class="product-image">
